...
3. request-path: leaf-local linear scans of query variants in [registry.cpp](../src/server/router/registry.cpp:270)
...
Severity: Critical  
Confidence: High  
Where: [registry.cpp](../src/server/router/registry.cpp:235), [registry.cpp](../src/server/router/registry.cpp:260)  
...
Evidence from the code/commits: `f11b35f` changed lookup to score query variants only after the path leaf is reached, but traversal still greedily prefers the literal child over the parameter child. Once [registry.cpp](../src/server/router/registry.cpp:260) takes the literal edge, the parameter branch is no longer explored.  
...
Severity: High  
Confidence: High  
Where: [request.hpp](../include/warp/http/request.hpp:102), [registry.cpp](../src/server/router/registry.cpp:285)  
...
Evidence from the code/commits: `f11b35f` introduced [registry.cpp](../src/server/router/registry.cpp:285) `match_query_constraints`, which repeatedly calls `req.query_param(constraint.name)`. The original implementation of [request.hpp](../include/warp/http/request.hpp:102) constructed `std::string(key)` before `unordered_map::find`.  
...
Severity: High  
Confidence: High  
Where: [registry.cpp](../src/server/router/registry.cpp:235), [registry.cpp](../src/server/router/registry.cpp:331), [route_pattern.hpp](../src/http/router/route_pattern.hpp:258)  
...
Severity: Medium  
Confidence: High  
Where: [registry.hpp](../src/server/router/registry.hpp:66), [registry.hpp](../src/server/router/registry.hpp:78), [registry.cpp](../src/server/router/registry.cpp:270)  
...
Where: [model.cpp](../src/codegen/model.cpp:426), [resource_stub_emitter.cpp](../src/codegen/resource_stub_emitter.cpp:167), [server_builder.hpp](../include/warp/server/server_builder.hpp:171), [callback_http_session.cpp](../src/server/session/callback_http_session.cpp:101)  
...
Severity: Medium  
Confidence: High  
Where: [http_adapter.hpp](../include/warp/codegen/http_adapter.hpp:629), [server_builder.hpp](../include/warp/server/server_builder.hpp:199), [callback_http_session.cpp](../src/server/session/callback_http_session.cpp:94)  
...
Severity: Medium  
Confidence: High  
Where: [server_builder.hpp](../include/warp/server/server_builder.hpp:171), [server_builder.cpp](../src/server/server_builder.cpp:53), [registry.cpp](../src/server/router/registry.cpp:161)  
...
Severity: Low  
Confidence: Medium  
Where: [registry.hpp](../src/server/router/registry.hpp:66), [registry.cpp](../src/server/router/registry.cpp:77)  
...
Severity: Medium  
Confidence: High, inferred  
Where: [route_spec.hpp](../include/warp/server/router/route_spec.hpp:85)  
...
Evidence from the code/commits: `0e373f8` introduced `route_spec` ambiguity logic, but runtime winner selection in [registry.cpp](../src/server/router/registry.cpp:317) depends on the joint score tuple.  
...
Where: [server_builder.hpp](../include/warp/server/server_builder.hpp:175), [registry.cpp](../src/server/router/registry.cpp:176)  
...
Severity: Medium  
Confidence: High  
Where: [route_spec.hpp](../include/warp/server/router/route_spec.hpp:85), [model.cpp](../src/codegen/model.cpp:448), [registry.cpp](../src/server/router/registry.cpp:317)  
...
Severity: Low  
Confidence: High  
Where: [request.hpp](../include/warp/http/request.hpp:15), [route_spec.hpp](../include/warp/server/router/route_spec.hpp:8)  
...
Path type: request-path  
Evidence: [route_pattern.hpp](../src/http/router/route_pattern.hpp:258), [registry.cpp](../src/server/router/registry.cpp:235), [registry.cpp](../src/server/router/registry.cpp:331)

3. Linear same-leaf query-variant scan  
Path type: request-path  
Evidence: [registry.cpp](../src/server/router/registry.cpp:270)

4. `route_spec` -> string -> runtime parse round-trip  
Path type: startup-path  
Evidence: [server_builder.hpp](../include/warp/server/server_builder.hpp:171), [server_builder.cpp](../src/server/server_builder.cpp:53)
